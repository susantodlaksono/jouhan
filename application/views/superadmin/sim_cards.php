         ...
         $(this).ajaxSubmit({
            type : "GET",
                ...
                success : function(r){
                  ...
                  $('.item_hapus[data-nope="'+no_hp+'"]').html('<i class="fa fa-remove"></i>');
                  if(r.success){
                     $('#offset').val(0);
                     $('#curpage').val(1);
                     $(this).render_data();
                     ...
                     var rak_no = "";
                        $.each(data.data, function(key,value){
                           ...
                           if(value.rak != ''){
                              ...
                              t+='<td><b>'+rak_nama+'</b> (Rak '+rak_no+')</td>';
                           }else{
                              t+='<td></td>';
                           }
                           ...
                           t += '<td>';
                              t += '<div class="btn-group">';
                                 t += '<button class="btn btn-white btn-sm btn-edit" data-toggle="tooltip" data-original-title="Edit" data-nope="'+value.no_handphone+'"><i class="fa fa-edit"></i></button>';
                                 t += '<button class="btn btn-white btn-sm item_hapus" data-toggle="tooltip" data-original-title="Delete" data-nope="'+value.no_handphone+'"><i class="fa fa-remove"></i></button>';
                              t += '</div>';
                           t += '</td>';
                           t+= '</tr>';
                        });
