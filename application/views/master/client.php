         ...
         <div class="modal-content">
            ...
            <form id="form-migration">
               <div class="modal-body">
                  ...
                  <p class="text-muted text-center bold" style="margin-top: -5px;"><a href="<?php echo site_url() ?>/master_client/format" class="text-center"> MigrationClient.xlsx</a></p>
                  <div class="form-group">
   ...
   <script type="text/javascript">
      ...
      $(function () {
         ...
         $.fn.render_data  = function(params){
            ...
            ajaxManager.addReq({
               type : "GET",
               url : site_url + '/master_client/get',
               dataType : "JSON",
               data : {
                  offset : str.offset,
                  curpage : str.curpage,
         ...
         $(this).on('submit', '#form-add', function(e){
            var form = $(this);
            $(this).ajaxSubmit({
               url  : site_url +'/master_client/create',
               type : "POST",
               dataType : "JSON",
               data : {
         ...
         $(this).on('submit', '#form-edit', function(e){
            var form = $(this);
            $(this).ajaxSubmit({
               url  : site_url +'/master_client/change',
               type : "POST",
               dataType : "JSON",
               data : {
                  'csrf_token_nalda' : $('#csrf').val()
         ...
         $(this).on('click', '.btn-edit',function(e){
            ...
            ajaxManager.addReq({
               type : "GET",
               url : site_url + '/master_client/edit',
               dataType : "JSON",
               data : {
                  id:id
               },
               ...
               success: function(r){
                  ...
                  form.find('input[name="description"]').val(r.response.description);
         ...
         $(this).on('click', '.btn-delete', function(e){
            ...
            if(conf){
               ...
               ajaxManager.addReq({
                  type : "GET",
                  url : site_url + '/master_client/delete',
                  dataType : "JSON",
                  data : {
                     id : id,
                  },
         ...
         $(this).on('submit', '#form-migration', function(e){
            var form = $(this);
            $(this).ajaxSubmit({
               url  : site_url +'/master_client/migration_all',
               type : "POST",
               dataType : "JSON",
               data : {
                  'csrf_token_nalda' : $('#csrf').val()
