...
$cell->setCellValue('C1', 'Username');
$cell->setCellValue('D1', 'Birth Date (Example : 2019-01-31)');
$cell->setCellValue('E1', 'Created Date (Example : 2019-01-31)');
...
$cell->getStyle('A1:M1')->getAlignment()->setHorizontal(PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
$cell->getStyle('A1:M1')->getAlignment()->setVertical(PHPExcel_Style_Alignment::VERTICAL_CENTER);
$cell->getStyle('A1:M1')->getFont()->setBold(TRUE);
foreach(range('A','N') as $column_id) {
 	$cell->getColumnDimension($column_id)->setAutoSize(true);
}
$cell->getStyle('A1:M1')->applyFromArray(
	array(
    	'fill' => array(
...
$filename = 'Format Migration Instagram';
