...
<?php
   ...
   $status_instagram = $this->db->get('instagram_status');
?>
<div class="row">
   <div class="col-md-12">
      <div class="panel panel-primary" data-collapsed="0">
         <div class="panel-heading">
            <div class="panel-title"><i class="fa fa-list"></i> List Instagram Account</div>
      ...
      <div class="modal-content">
         ...
         <div class="modal-body">
            <form id="form-download-client" method="post" action="<?php echo site_url().'reporting/downloadByClient' ?>">
               <input type="hidden" name="cluster" value="instagram">
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <select id="filter_status" class="form-control choose" multiple="">
                           <?php
                           foreach ($status_instagram->result_array() as $key => $value) {
                              echo '<option value="'.$value['id'].'">'.$value['name'].'</option>';
                           }
                           ?>
                        </select>
                  ...
                  <div class="col-md-6">
                     <div class="form-group">
                        ...
                        <select id="filter_sort" class="form-control">
                           <option value="a.created_instagram" selected="">Created Twitter</option>
...
<div class="modal" id="modal-delete">
   <div class="modal-dialog" style="width: 40%;">
      <div class="modal-content">
         <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            <h3 class="modal-title Blocked"><i class="fa fa-trash"></i> Delete</h3>
         </div>
         <form id="form-delete">
            ...
            <div class="modal-body">
               <div class="form-group">
                  ...
                  <select name="mode[]" class="form-control choose" multiple="">
                    <option value="1" selected="">Only instagram</option>
               ...
               <div class="row">
                  <div class="col-md-6">
                     ...
                     <div class="form-group">
                        <div class="row">
                           <div class="col-md-6">
                              <label>Username <span class="text-require">(*)</span></label>
                              <input type="text" class="form-control" name="username" id="username_create" required="">
                           </div>
                           <div class="col-md-6">
                     ...
                     <div class="form-group">
                        <div class="row">
                           ...
                           <div class="col-md-12">
                              ...
                              <input type="hidden" name="created_instagram">
                              <div class="input-group">
                     ...
                     <div class="form-group">
                        <div class="row">
                           <!-- <div class="col-md-6">
                              ...
                              <input type="hidden" name="birth_date">
                              <div class="input-group">
                                 <input type="text" class="form-control date-birthdate" data-formrender="#form-edit" required="">
                                 <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                              </div>
                           </div> -->
                           <div class="col-md-12">
         ...
         <form id="form-bulk-client">
            <div class="modal-body">
               ...
               <p class="text-muted text-center bold" style="margin-top: -5px;">
                  <a href="<?php echo site_url('instagram/bulkFormat/1') ?>" class="text-center"> PhoneNumberList.xlsx</a> |
                  <a href="<?php echo site_url('instagram/bulkFormat/2') ?>" class="text-center"> UsernameList.xlsx</a>
               </p>               
               <div class="form-group">
      ...
      <div class="modal-content">
         ...
         <form id="form-migration">
            <div class="modal-body">
               ...
               <p class="text-muted text-center bold" style="margin-top: -5px;"><a href="<?php echo site_url() ?>instagram/download_format" class="text-center"> Format Migration Instagram.xlsx</a></p>
               <div class="form-group">
                  <label>Upload Format</label>
                  <input type="file" name="userfile" class="form-control">
               </div>
...
<script type="text/javascript">
   ...
   $(function () {
      ...
      $('#username_create').keyup(function () { 
                  ...
                  $.each(data.data, function(k,v){
                     t += '<tr>';
                        ...
                        t += '<td>';
                           t += '<b>'+v.pic+'</b></br>';
                           if(v.pic_updated){
                              t += '<a style="cursor:pointer" data-toggle="tooltip" data-placement="top" title="" data-original-title="By '+v.pic_updated+' at '+v.updated_date+'"><i class="fa fa-external-link"></i></a> at '+v.created_instagram+'';
                           }else{
                              t += 'at '+v.created_instagram+'';
                           }
                        t += '</td>';
                        t += '<td>';
                           if(v.phone_number){
                        ...
                        t += '</td>';
                        t += '<td><b>'+(v.username ? '<a href="http://www.instagram.com/'+v.username+'" target="_blank">'+v.username+'</a>' : '')+'</b></td>';
      ...
      $.fn.render_phone_number  = function(params){
         ...
         ajaxManager.addReq({
            type : "GET",
            url : site_url + '/instagram/get_phone_number',
            dataType : "JSON",
            data : {
      ...
      $(this).on('click', '.btn-edit',function(e){
         ...
         ajaxManager.addReq({
            ...
            success: function(r){
               ...
               form.find('input[name="username_before"]').val(r.response.username);
               if(r.response.created_instagram){
                  form.find('.date-data').val(moment(r.response.created_instagram).format('DD/MMM/YYYY'));
                  form.find('input[name="created_instagram"]').val(r.response.created_instagram);
               }else{
                  form.find('.date-data').val('');
                  form.find('input[name="created_instagram"]').val('');
               }
      ...
      $(this).on('click', '.btn-search-phone-number', function(e){
         ...
         if(phone !== ''){
            ajaxManager.addReq({
               type : "GET",
               url : site_url + 'instagram/find_phone',
               dataType : "JSON",
               data : {
                  phone : phone
               },
               ...
               success : function(r){
                  if(r.response){
                     if(r.response.registered_instagram == 0 && r.response.registered == 1){
                     ...
                     }else if(r.response.registered_instagram == 1){
                     ...
                     }else if(r.response.registered_instagram == 0 && r.response.registered == 0){
                        $('#'+render+'').find('input[name="phone_number"]').val('');
      ...
      $('.bulk_action').on('click', function(e) {
         ...
         if (data.length > 0) {
            ajaxManager.addReq({
               url: site_url + '/instagram/bulk_action',
               type: 'POST',
               dataType: 'JSON',
               data: {
                  mode: mode,
      ...
      $(this).on('click', '.set-empty',function(e){
         $('#form-filter').find('.date-expiredsimcard').val('');
         $('#form-filter').find('input[name="filter_expireddate"]').val('');
      });
      ...
      $.fn.render_picker = function (opt) {
         ...
         $('.date-data').on('apply.daterangepicker', function(ev, picker) {
            ...
            $(formrender).find('input[name="created_instagram"]').val(picker.startDate.format('YYYY-MM-DD'));
         });
      ...
      $(this).on('submit', '#form-bulk-client', function(e){
         var form = $(this);
         $(this).ajaxSubmit({
            url  : site_url +'instagram/bulkInstagram',
            type : "POST",
            dataType : "JSON",
            data : {
               'csrf_token_nalda' : $('#csrf').val()
      ...
      $(this).on('submit', '#form-migration', function(e){
         var form = $(this);
         $(this).ajaxSubmit({
            url  : site_url +'instagram/migration_all',
            type : "POST",
            dataType : "JSON",
            data : {
               'csrf_token_nalda' : $('#csrf').val()
      ...
      $(this).on('submit', '#form-assign-client', function(e){
         ...
         $(this).ajaxSubmit({
            url  : site_url +'instagram/assign_client',
            type : "POST",
            dataType : "JSON",
            data : {
               'csrf_token_nalda' : $('#csrf').val(),
