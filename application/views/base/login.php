...
<body style="background-color: #303641">
   <div class="col-md-12" style="border:0px solid black;">
      <div class="row">
         <div class="col-md-4 col-md-offset-4" style="border:1px solid #393b3e;padding:50px;margin-top: 70px;background-color: #464d5a;border-radius:5px;">
            <div class="col-md-12 text-center">
               <a href="<?php echo site_url() ?>" class="logo">
                  <img src="<?php echo base_url() ?>indosiar.png" width="100" alt="" />
               </a>
            </div>
            <div class="col-md-12 text-center" style="margin-top:20px;">
               <h1 style="color:#fff;margin-top: -10px;" class="bold">Jouhan</h1>
               <h4 style="color:#fff;margin-top: -10px;">Jual Beli Louhan</h4>
               <h5 style="color:#fff;"><span class="label label-default"><?php echo config_item('cluster') ?></span></h5>
            </div>
